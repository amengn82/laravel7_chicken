...
<html lang=" {{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            @endif
                <div class="logo">
                    <a href="{{ URL::to('/') }}"><img src="{{ asset('images/KFC_logo.png') }}" alt="KFC_logo.png"></a>
                </div>
                <nav>
                    <ul>
            ...
            <footer>
                <nav>
                    ...
                    <br>
                    <p><img style="width:30px; height:30px;" src="{{ asset('images/gmail.png') }}" alt="gmail.png">kfc@kfc.com</p>
                    <p><img style="width:30px; height:30px;" src="{{ asset('images/address.png') }}" alt="address.png">KFC สาขา 500 พาลิเซดเซอร์ แอชวิลล์ นอร์ทแคโรไลนา 28803 สหรัฐอเมริกา</p>
                    <p>&copy; ลิขสิทธิ์ 2023 โดยเคเอฟซี ขอสงวนลิขสิทธิ์</p>
                </nav>
            </footer>
            @yield('script')
    </body>
