...
<div class="container">
    <section class="content">
        <div class="content-img">
            <img src="{{ asset('images/drivethru.jpg') }}" alt="drivethru.jpg">
        </div>
        <div class="content-info">
            <h1>เปิดทำการทุกวัน</h1>
            <p>KFC Drive Thru เปิดทำการทุกวัน ตลอด 24 ชั่งโมง รับเฉพาะออเดอร์ Pick up เท่านั้น</p>
        </div>
        <div class="clear"></div>
    </section>
    <section>
        <address>
            <p>KFC สาขา 500 พาลิเซดเซอร์<br>
